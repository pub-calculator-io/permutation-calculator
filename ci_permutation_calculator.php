...
Version: 1.0.0
Author: Permutation Calculator / www.calculator.io
...
function display_calcio_ci_permutation_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_permutation_calculator', 'display_calcio_ci_permutation_calculator' );